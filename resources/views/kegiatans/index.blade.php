...
<div class="container mx-auto px-4 py-8"> {{-- Menggunakan container responsif dari layout --}}
    <div class="flex flex-col sm:flex-row justify-between items-center mb-6"> {{-- Flexbox untuk judul dan tombol --}}
        <h1 class="text-2xl font-bold text-purple-800 mb-4 sm:mb-0">Daftar Kegiatan</h1> {{-- Ukuran teks responsif --}}
        <a href="{{ route('kegiatans.create') }}" class="inline-block bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out w-full sm:w-auto text-center"> {{-- Tombol responsif --}}
    ...
    <div class="overflow-x-auto bg-white shadow-md rounded-lg"> {{-- Membuat tabel bisa discroll horizontal pada layar kecil --}}
        <table class="min-w-full leading-normal"> {{-- min-w-full memastikan tabel tidak menyusut --}}
            ...
            <tbody class="text-gray-600 text-sm font-light">
                ...
                <tr class="border-b border-gray-200 hover:bg-purple-50">
                    ...
                    <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center space-x-2"> {{-- Flexbox untuk tombol aksi --}}
                            <a href="{{ route('kegiatans.show', $kegiatan->id) }}" class="bg-purple-500 hover:bg-purple-600 text-white font-bold py-1 px-2 rounded text-xs transition duration-300 ease-in-out">Detail</a>
                ...
                @empty
                <tr>
                    <td colspan="4" class="py-3 px-6 text-center text-purple-500">Tidak ada kegiatan yang ditemukan.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
