...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl sm:text-3xl font-bold mb-6 text-purple-800 text-center">Pindai QR Code Kehadiran</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6 max-w-lg mx-auto">
        ...
        <div class="mb-4">
            ...
            <select name="kegiatan_id" id="kegiatan_id_qr" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent" required>
        ...
        <div id="qr-reader-results" class="mt-4 text-center">
            ...
            <p id="qr-result-text" class="text-purple-600"></p>
