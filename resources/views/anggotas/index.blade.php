...
<div class="container mx-auto px-4 py-8"> {{-- Menggunakan container responsif dari layout --}}
    <div class="flex flex-col sm:flex-row justify-between items-center mb-6"> {{-- Flexbox untuk judul dan tombol --}}
        <h1 class="text-2xl font-bold text-purple-800 mb-4 sm:mb-0">Daftar Anggota</h1> {{-- Ukuran teks responsif --}}
        <a href="{{ route('anggotas.create') }}" class="inline-block bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out w-full sm:w-auto text-center"> {{-- Tombol responsif --}}
            Tambah Anggota
        </a>
    </div>
